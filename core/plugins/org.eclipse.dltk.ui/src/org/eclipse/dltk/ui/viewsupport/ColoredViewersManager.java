...
public class ColoredViewersManager implements IPropertyChangeListener {
	...
	public static final String INHERITED_COLOR_NAME = "org.eclipse.dltk.ui.ColoredLabels.inherited"; //$NON-NLS-1$

	public static final String HIGHLIGHT_BG_COLOR_NAME = "org.eclipse.dltk.ui.ColoredLabels.match_highlight"; //$NON-NLS-1$
	public static final String HIGHLIGHT_WRITE_BG_COLOR_NAME = "org.eclipse.dltk.ui.ColoredLabels.writeaccess_highlight"; //$NON-NLS-1$
	...
	public void propertyChange(PropertyChangeEvent event) {
		...
		if (property.equals(JFacePreferences.QUALIFIER_COLOR)
				...
				|| property.equals(INHERITED_COLOR_NAME) || property.equals(
	...
	protected final void updateAllViewers() {
		for (Iterator iterator = fManagedLabelProviders.iterator(); iterator
				.hasNext();) {
